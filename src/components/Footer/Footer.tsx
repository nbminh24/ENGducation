                ...
                <div className={styles.columns}>
                    ...
                    <div className={styles.col}>
                        ...
                        <div className={styles.socials}>
                            <a href="https://facebook.com" aria-label="Facebook"><svg width="24" height="24" fill="none" viewBox="0 0 24 24"><path d="M17 2.05C16.11 2 15.22 2 14.33 2C9.61 2 6 5.61 6 10.33V12H2v4h4v8h4v-8h3l1-4h-4v-1.67C10 7.61 11.61 6 14.33 6c.89 0 1.78 0 2.67.05V2.05z" fill="#3540e8" /></svg></a>
                            <a href="https://instagram.com" aria-label="Instagram"><svg width="24" height="24" fill="none" viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="6" stroke="#3540e8" strokeWidth="2" /><circle cx="12" cy="12" r="5" stroke="#3540e8" strokeWidth="2" /><circle cx="17.5" cy="6.5" r="1.5" fill="#3540e8" /></svg></a>
